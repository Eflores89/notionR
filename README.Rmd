...
This is a wrapper functions to access [Notion API](https://developers.notion.com") using R
...
- Read the "Getting Started" from Notion API : https://developers.notion.com/docs/getting-started
